...
class parallel_device(device):
    ...
    def __init__(self, const=None, serial_interface=None, exec_time=1e-6 * 50, **kwargs):
    ...
    def _eight_to_four(self, data):
        """
        Convert list of bytes (8 bit values) into a list of nibbles (4 bit values)
        """
