...
SEG7_FONT = [
    ...
    [0x00, 0x00, 0x00, 0x00],  # '?'
    [0x00, 0x00, 0x00, 0x00],  # '@'
    [0x7F, 0x48, 0x7F, 0x00],  # 'A'
    [0x7F, 0x49, 0x7F, 0x00],  # 'B'
    [0x7F, 0x41, 0x41, 0x00],  # 'C'
    [0x7F, 0x41, 0x3E, 0x00],  # 'D'
    [0x7F, 0x49, 0x49, 0x00],  # 'E'
    [0x7F, 0x48, 0x48, 0x00],  # 'F'
    [0x7F, 0x41, 0x47, 0x00],  # 'G'
    [0x7F, 0x08, 0x7F, 0x00],  # 'H'
    [0x41, 0x7F, 0x41, 0x00],  # 'I'
    [0x41, 0x7F, 0x40, 0x00],  # 'J'
    [0x7F, 0x08, 0x17, 0x00],  # 'K'
    [0x7F, 0x01, 0x01, 0x00],  # 'L'
    [0x7F, 0x70, 0x7F, 0x00],  # 'M'
    [0x7F, 0x40, 0x7F, 0x00],  # 'N'
    [0x7F, 0x41, 0x7F, 0x00],  # 'O'
    [0x7F, 0x48, 0x78, 0x00],  # 'P'
    [0x7E, 0x42, 0x7F, 0x00],  # 'Q'
    [0x7F, 0x48, 0x77, 0x00],  # 'R'
    [0x79, 0x49, 0x4F, 0x00],  # 'S'
    [0x40, 0x7F, 0x40, 0x00],  # 'T'
    [0x7F, 0x01, 0x7F, 0x00],  # 'U'
    [0x7E, 0x01, 0x7E, 0x00],  # 'V'
    [0x7F, 0x07, 0x7F, 0x00],  # 'W'
    [0x77, 0x08, 0x77, 0x00],  # 'X'
    [0x70, 0x0F, 0x70, 0x00],  # 'Y'
    [0x47, 0x49, 0x71, 0x00],  # 'Z'
    [0x00, 0x00, 0x00, 0x00],  # '['
    [0x00, 0x00, 0x00, 0x00],  # '\'
    [0x00, 0x00, 0x00, 0x00],  # ']'
    [0x00, 0x00, 0x00, 0x00],  # '^'
